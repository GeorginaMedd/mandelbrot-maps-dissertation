...
import WelcomePopup from './components/mode-components/WelcomePopup.jsx';
import EducationPopup from './components/mode-components/EducationPopup.jsx';
import GuidedPopup from './components/mode-components/GuidedPopup.jsx';

import FirstTimeAlert from './components/mode-components/FirstTimeAlert';
...
function App({ settings }: { settings: settingsDefinitionsType }): JSX.Element {
  ...
  const toggleEducation = () => {
    setIsEducationToggled((i) => !i);
  };

  const [isSiteTourToggled, setIsSiteTourToggled] = useState(false);
  const toggleSiteTour = () => {
    setIsSiteTourToggled((i) => !i);
  };
